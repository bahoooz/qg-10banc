        ...
        {users
          ...
          ?.map((u) => {
            ...
            return (
              <button
                key={u.id}
                className="flex gap-5 md:gap-6 items-center cursor-pointer hover:opacity-50 transition-all hover:scale-95"
              ...
              >
                <div className="relative overflow-hidden">
                  ...
                  ></div>
                  <img
                    className="object-cover aspect-square rounded-full md:w-28"
                    src={u.avatar}
                    alt={u.username}
                    width={84}
                    height={84}
                ...
                <h3 className="text-xl md:text-2xl">{u.username}</h3>
              </button>
            );
          })}
      </div>
