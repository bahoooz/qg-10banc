...
const MenuBar = ({ editor }: { editor: Editor | null }) => {
  ...
  return (
    <div className="bg-background-secondary rounded-xl p-2 flex gap-2 overflow-auto scrollbar-thin items-center *:cursor-pointer">
      <button
        type="button"
...
export const TipTapEditor = ({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          "prose prose-invert prose-sm sm:prose lg:prose-lg xl:prose-2xl focus:outline-none h-full [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_h1]:text-3xl [&_h1]:font-bold [&_h1]:mb-4 [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:mb-4 [&_h2]:mt-6 [&_h3]:text-xl [&_h3]:font-bold [&_p]:my-2 [&_a]:text-blue-400 [&_a]:underline cursor-text [&_img]:max-w-full [&_img]:rounded-lg",
      },
    },
  });
  ...
  return (
    <div className={`${className} h-full w-screen -left-4 absolute z-20 p-4`}>
      <div className="flex flex-col gap-4 h-full">
        <MenuBar editor={editor} />

        <div className="text-white bg-background-secondary rounded-xl p-3 h-[80%] max-h-[80%] overflow-auto scrollbar-thin">
        ...
        <div className="flex justify-between">
          <button
            onClick={onClose}
            className="bg-background-secondary rounded-lg transition-all hover:scale-[102%] cursor-pointer h-10 px-6 text-white"
          >
            Fermer
          </button>
          <button
            ...
            className="bg-secondary-color rounded-lg transition-all hover:scale-[102%] cursor-pointer h-10 px-6 text-white"
          >
            Sauvegarder
          </button>
        </div>
