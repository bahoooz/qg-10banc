...
export default function ClipNameDialog({
  open,
  defaultName = "",
  onClose,
  onConfirm,
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="clip-name-title"
      onClick={handleClose}
    >
      <div
      ...
      >
        <div className="mb-4 flex items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-xs text-white/40">
              Ce clip sera enregistré et accessible depuis « Parcourir les clips ».
            </p>
          </div>
          <button
            type="button"
        ...
        <label className="block">
          ...
          <input
            ...
            maxLength={80}
            placeholder="Ex. Best-of stream #12"
