import { Circle, LayoutTemplate, RectangleHorizontal, Square } from "lucide-react";
import { useState } from "react";
import type { CamShape } from "../../lib/clipLayout";
import { useClipEditorStore } from "../../stores/clipEditorStore";
import ClipTemplatePickerDialog from "./ClipTemplatePickerDialog";
      ...
      <div className="flex shrink-0 flex-col gap-3 border-b border-secondary-color/40 pb-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="ml-auto inline-flex items-center gap-1.5 rounded-lg border border-secondary-color/50 px-2.5 py-1.5 text-[10px] font-extrabold uppercase tracking-wide text-white/50 transition-all hover:border-main-color/40 hover:text-main-color"
          >
